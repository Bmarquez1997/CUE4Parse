...
public class FStaticMeshRenderData
{
    ...
    public FStaticMeshRenderData(FAssetArchive Ar)
    {
        ...
        if (Ar.Game is >= GAME_UE4_23 or EGame.GAME_Fortnite_S10 or EGame.GAME_Fortnite_S9)
        {
        ...
        if (Ar.Game is >= GAME_UE5_4 and not EGame.GAME_Fortnite_S27) _ = Ar.Read<FStripDataFlags>();
    }
