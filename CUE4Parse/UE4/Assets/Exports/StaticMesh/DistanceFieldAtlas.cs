...
namespace CUE4Parse.UE4.Assets.Exports.StaticMesh
{
    ...
    public class FSparseDistanceFieldMip
    {
        ...
        public FSparseDistanceFieldMip(FArchive Ar)
        {
            ...
            if (Ar.Game is >= GAME_UE5_4 and not EGame.GAME_Fortnite_S27)
            {
    ...
    public class FDistanceFieldVolumeData5
    {
        ...
        {
            LocalSpaceMeshBounds = (Ar.Game is >= GAME_UE5_4 and not EGame.GAME_Fortnite_S27) || Ar.Game is GAME_Highguard ? Ar.Read<FBox>() : new FBox(Ar);
