...
public enum EGame : uint
{
    ...
    GAME_UE4_22 = GameUtils.GameUe4Base + (22 << 16),
        GAME_Fortnite_S9 = GAME_UE4_22 + 1,
        GAME_Fortnite_S10 = GAME_UE4_22 + 2,
    ...
    GAME_UE5_2 = GameUtils.GameUe5Base + (2 << 16),
        ...
        GAME_Fortnite_S24 = GAME_UE5_2 + 6,
    ...
    GAME_UE5_4 = GameUtils.GameUe5Base + (4 << 16),
        ...
        GAME_SplitFiction = GAME_UE5_4 + 6,
        GAME_WildAssault = GAME_UE5_4 + 7,
        GAME_InZOI = GAME_UE5_4 + 8,
        GAME_TempestRising = GAME_UE5_4 + 9,
