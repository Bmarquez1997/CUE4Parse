...
namespace CUE4Parse.UE4.Versions
{
    public class VersionContainer : ICloneable
    {
        ...
        private void InitOptions()
        {
            ...
            Options["SkeletalMesh.UseNewCookedFormat"] = Game is >= GAME_UE4_24 or GAME_Fortnite_S10;
            ...
            Options["StaticMesh.HasVisibleInRayTracing"] = Game is >= GAME_UE4_26 or GAME_Back4Blood;
